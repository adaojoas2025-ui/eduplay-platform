  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Gerenciar Combos</h1>
          <p className="text-gray-600 mt-1">Crie combos de produtos com descontos especiais</p>
        </div>
        <button
      ...
      {combos.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-lg shadow">
          ...
          <p className="text-gray-500 text-lg">Nenhum combo criado ainda</p>
          <button
            onClick={() => handleOpenModal()}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="border border-gray-300 rounded-lg p-4 max-h-60 overflow-y-auto">
                    {products.length === 0 ? (
                      <p className="text-gray-500 text-center">Nenhum produto disponível</p>
                    ) : (
