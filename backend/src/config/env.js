...
const envSchema = Joi.object({
  ...
  PLATFORM_NAME: Joi.string().default('EducaplaJA'),
  PLATFORM_EMAIL: Joi.string().email().default('contato@educaplaja.com.br'),
  PLATFORM_SUPPORT_EMAIL: Joi.string().email().default('suporte@educaplaja.com.br'),
