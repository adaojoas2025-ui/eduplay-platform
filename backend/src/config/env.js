...
const envSchema = Joi.object({
  ...
  PLATFORM_NAME: Joi.string().default('EDUPLAY'),
  PLATFORM_EMAIL: Joi.string().email().default('contato@eduplay.com.br'),
  PLATFORM_SUPPORT_EMAIL: Joi.string().email().default('suporte@eduplay.com.br'),
